...
|---|---|---|
| `DATASET_AUDIT_SPRING_INX_R1.md` | audit of the 116 stereo calls, and why R1. The same audit run against Malayalam R1 is current, not archived: [`docs/dataset_malayalam_r1.md`](../dataset_malayalam_r1.md) | `pipeline/01_manifest.py`, `docs/dataset.md` |
...
| `RESEARCH_LABELLING.md` | how EOT training data gets labelled anywhere, why no South-Indian language had a model, and the licence position on LLM-assisted labelling | — |
